...
const navItems = [
  { label: 'Start', english: 'Home', href: '/' },
  { label: 'Marke', english: 'Brand', href: '/about' },
  { label: 'Produkte', english: 'Products', href: '/data' },
  { label: 'Technik', english: 'Technology', href: '/philosophy' },
...
const pageSeo = {
  home: {
    seo: {
      title: 'Paterson Öko-Wohnen Franchise',
      description: 'Seit 2001 entwickelt Paterson Wasserlack-Schrank-, Wand- und Türsysteme sowie Öko-Wohnlösungen mit Franchise-Support.',
  ...
  about: {
    seo: {
      title: 'Markenstärke',
      description: 'Erfahren Sie mehr über Paterson Geschichte, Der Future Rückhalt, Wasserlack-Technologie und Franchise-Support.',
  ...
  articles: {
    seo: {
      title: 'News',
      description: 'Lesen Sie Paterson News zu Wasserlack-Technologie, Messen, Auszeichnungen und Wohnlösungen.',
  ...
  contact: {
    inquiry: {
      ...
      submitting: 'Sendet',
      success: 'Gesendet. Wir melden uns bald.',
...
const starter = {
  ...
  languageSwitcher: {
    ...
    languages: {
      'zh-CN': {
        label: '简体中文',
        localeName: 'Chinesisch vereinfacht',
        searchTerms: ['Chinesisch', 'Mandarin', 'zh']
      },
      'zh-TW': {
        label: '繁體中文',
        localeName: 'Chinesisch traditionell',
        searchTerms: ['Traditionelles Chinesisch', 'Chinesisch', 'tw']
      },
      'en': {
        label: 'English',
        localeName: 'Englisch',
        searchTerms: ['Englisch', 'en']
      },
      'ru': {
        label: 'Русский',
        localeName: 'Russisch',
        searchTerms: ['Russisch', 'ru']
      },
      'de': {
        label: 'Deutsch',
        localeName: 'Deutsch',
        searchTerms: ['Deutsch', 'de']
      },
      'it': {
        label: 'Italiano',
        localeName: 'Italienisch',
        searchTerms: ['Italienisch', 'it']
      },
      'es': {
        label: 'Español',
        localeName: 'Spanisch',
        searchTerms: ['Spanisch', 'es']
      },
      'fr': {
        label: 'Français',
        localeName: 'Französisch',
        searchTerms: ['Französisch', 'fr']
      }
    }
  },
  nav: {
    ...
    memberCenter: 'Anfrage',
    hotline: 'Franchise-Hotline',
    stockLabel: 'Aktiencode',
    topInfoBrand: 'Teil von Der Future',
    items: navItems,
    search: {
  ...
  philosophyPage: {
    seo: {
      title: 'Wasserlack-Technologie',
      description: 'Erfahren Sie mehr über Paterson Wasserlack-Materialien, intelligente Beschichtung, Fabrik-Upgrades und Öko-Wohntechnologie.',
  ...
  dataPage: {
    seo: {
      ...
      description: 'Entdecken Sie Paterson Schränke, Möbel und Wohnsysteme mit Wasserlack-Materialien und gesundem Wohnwert.',
  ...
  contactPage: {
    seo: {
      title: 'Franchise-Anfrage',
      description: 'Entdecken Sie Paterson Franchise-Vorteile, Support, Ablauf und Richtlinien. Senden Sie Stadt und Kontaktdaten für Informationen.',
  ...
  designSystemPage: {
    seo: {
      title: 'Brand Visuals',
      description: 'Entdecken Sie Farben, Typografie, Abstände und Interaktionen der Paterson Website.',
  ...
  legal: {
    ...
    privacy: {
      seo: {
        ...
        description: 'Erfahren Sie, wie wir personenbezogene Daten erheben, nutzen, speichern und schützen.',
    ...
    terms: {
      seo: {
        title: 'Terms of Use',
        description: 'Lesen Sie die grundlegenden Bedingungen für den Zugriff auf diese Website.',
